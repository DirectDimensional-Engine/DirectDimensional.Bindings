...
namespace DirectDimensional.Bindings.Direct3D11 {
    ...
    public sealed unsafe class RenderTargetView : ResourceView {
        public RenderTargetView(IntPtr ptr) : base(ptr) {
        }

        public D3D11_RENDER_TARGET_VIEW_DESC Description {
            get {
                IntPtr address = (*(IntPtr*)_nativePointer) + 8 * IntPtr.Size;
                var @delegate = (delegate* unmanaged[Stdcall]<IntPtr, D3D11_RENDER_TARGET_VIEW_DESC*, void>)(*(IntPtr*)address);
